...
public class transaksi extends barang {
    ...
    public void save() throws SQLException{//menyimpan data
        ...
        try{
            ...
            String sql = "INSERT INTO minimarket (nobarang, namabarang, ukuranbarang, harga, jumlah) VALUES ('"+kodebarang+"','"+namabrg+"','"+ukurannya+"','"+hargabrg+"' ,'"+jumlahbrg+"')";
    ...
    public void update() throws SQLException{
        ...
        try{
            ...
            if (result.next())
            {
                ...
                System.out.print("\n");
                sql = "UPDATE minimarket SET namabarang='"+namabarubrg+"' WHERE nobarang='"+keywordd+"'";
